...
import (
	...
	"github.com/onosproject/config-adapter/pkg/gnmiclient"
...
func (m *Migrator) outputActions(actions []*MigrationActions,
	...
	topLevel["Extensions"] = map[string]string{
		"model-type-102": "Aether", // TODO: This code should be model-agnostic. This should be passed in from outsite.
	}
